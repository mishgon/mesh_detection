...
def train_val_test_split(indices, n_splits=5, val_size=30, random_state=42):
    ...
    return [[*train_test_split(train, test_size=val_size, shuffle=False, random_state=random_state), test]
...
def stratified_train_val_test_split(indices, labels, n_splits=5, val_size=30, random_state=42):
    ...
    return [[*train_test_split(train, test_size=val_size, stratify=labels[train], random_state=random_state), test]
            for train, test in split]
